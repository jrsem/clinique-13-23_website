...
<span className="uppercase tracking-widest text-xs font-bold text-clinique_rose">Total Health Care Solution</span>
</div>
...
<div className="text-novena-navy mb-4">
...
<span className="text-novena-gray text-xs mb-1">24 Hours Service</span>
<h3 className="text-xl font-bold text-novena-navy mb-4">Online Appointment</h3>
<p className="text-novena-gray text-sm leading-relaxed mb-6">
            Get ALI time support for emergency. We have introduced the principle of family medicine.
          </p>
<a className="bg-novena-navy text-white px-6 py-3 rounded-full text-xs font-bold uppercase tracking-wider hover:bg-blue-900 transition mt-auto" href="#">
            Make a Appointment
          </a>
</div>
...
<span className="text-novena-gray text-xs mb-1">Timing schedule</span>
<h3 className="text-xl font-bold text-novena-navy mb-6">Working Hours</h3>
...
<span className="text-novena-gray text-xs mb-1">Emergency Cases</span>
<h3 className="text-2xl font-bold text-novena-navy mb-4">1-800-700-6200</h3>
<p className="text-novena-gray text-sm leading-relaxed">
            Get ALI time support for emergency. We have introduced the principle of family medicine. Get connected with us for any urgency.
          </p>
</div>
</div>
</section>
